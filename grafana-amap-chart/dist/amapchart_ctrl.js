...
System.register(['app/plugins/sdk', 'lodash', 'app/core/utils/kbn', 'app/core/time_series', './rendering'], function (_export, _context) {
  ...
  var MetricsPanelCtrl, _, kbn, TimeSeries, rendering, _createClass, AmapChartCtrl;
  ...
  return {
    ...
    execute: function () {
      ...
      _export('AmapChartCtrl', AmapChartCtrl = function (_MetricsPanelCtrl) {
        _inherits(AmapChartCtrl, _MetricsPanelCtrl);

        function AmapChartCtrl($scope, $injector, $rootScope) {
          _classCallCheck(this, AmapChartCtrl);

          var _this = _possibleConstructorReturn(this, (AmapChartCtrl.__proto__ || Object.getPrototypeOf(AmapChartCtrl)).call(this, $scope, $injector));
        ...
        return AmapChartCtrl;
      }(MetricsPanelCtrl));

      _export('AmapChartCtrl', AmapChartCtrl);

      AmapChartCtrl.templateUrl = 'module.html';
    }
  };
});
//# sourceMappingURL=amapchart_ctrl.js.map
